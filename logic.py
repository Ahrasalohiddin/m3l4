...
if __name__ == '__main__':
    ...
    #manager.insert_skill(111,, 'Bot AITranslatior' 'Python')
    #manager.insert_project(111, 'AITranslatior', 'https://github.com/)
    num = manager.get_project_id(111, 'Bot AITranslatior')
    print(num)
